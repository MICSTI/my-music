<?php
	...
	if ($_GET) {
		...
		$header = array(array('name' => 'Timestamp', 'display' => 'Timestamp'), array('name' => 'SongName', 'display' => 'Title'), array('name' => 'ArtistName', 'display' => 'Artist'), array('name' => 'RecordName', 'display' => 'Record'));
		echo $mc->getIndexHTML($mc->getTableFromArray('history', $header, $mc->getMDB()->getPlayedHistoryForDate($date)));
	}
